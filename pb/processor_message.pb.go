...
var file_processor_message_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0e, 0x6e, 0x63, 0x68, 0x75, 0x6b,
	0x6b, 0x61, 0x69, 0x6f, 0x2e, 0x67, 0x6f, 0x70, 0x63, 0x1a, 0x14, 0x6d, 0x65, 0x6d, 0x6f, 0x72,
...
var file_processor_message_proto_goTypes = []interface{}{
	(*CPU)(nil),    // 0: nchukkaio.gopc.CPU
	(*GPU)(nil),    // 1: nchukkaio.gopc.GPU
	(*Memory)(nil), // 2: nchukkaio.gopc.Memory
}
var file_processor_message_proto_depIdxs = []int32{
	2, // 0: nchukkaio.gopc.GPU.memory:type_name -> nchukkaio.gopc.Memory
